...
export const HomeSportsPromo: React.FC = () => {
  return (
    <section className="mb-8 overflow-hidden rounded-xl border border-tuao-dark-700/90 bg-tuao-dark-900 shadow-panel">
      <div className="flex flex-col gap-6 p-6 md:flex-row md:items-center md:justify-between md:p-8">
        <div className="flex gap-4">
          ...
          <div>
            <h2 className="text-xl font-black tracking-tight text-white md:text-2xl">Esportes</h2>
            <p className="mt-1 max-w-xl text-sm leading-relaxed text-tuao-text-secondary">
              Nossas apostas esportivas são feitas para jogadores novos e experientes.
            </p>
          </div>
        </div>
        <Link
